export const mimeTypes = [
    ...
    { extension: ".abw", mime_type: "application/x-abiword" },
    { extension: ".arc", mime_type: "application/x-freearc" },
    { extension: ".avif", mime_type: "image/avif" },
    { extension: ".avi", mime_type: "video/x-msvideo" },
    { extension: ".azw", mime_type: "application/vnd.amazon.ebook" },
    ...
    { extension: ".cda", mime_type: "application/x-cdf" },
    ...
    { extension: ".gz", mime_type: "application/gzip" },
    ...
    { extension: ".ics", mime_type: "text/calendar" },
    { extension: ".jar", mime_type: "application/java-archive" },
    ...
    { extension: ".jsonld", mime_type: "application/ld+json" },
    { extension: ".mid", mime_type: "audio/midi" },
    { extension: ".midi", mime_type: "audio/midi" },
    { extension: ".mjs", mime_type: "text/javascript" },
    ...
    { extension: ".ogx", mime_type: "application/ogg" },
    { extension: ".opus", mime_type: "audio/opus" },
    { extension: ".otf", mime_type: "font/otf" },
    ...
    { extension: ".rar", mime_type: "application/vnd.rar" },
    ...
    { extension: ".ts", mime_type: "video/mp2t" },
    { extension: ".ttf", mime_type: "font/ttf" },
    { extension: ".txt", mime_type: "text/plain" },
    { extension: ".vsd", mime_type: "application/vnd.visio" },
    { extension: ".wav", mime_type: "audio/wav" },
    { extension: ".weba", mime_type: "audio/webm" },
    { extension: ".webm", mime_type: "video/webm" },
    { extension: ".webp", mime_type: "image/webp" },
    { extension: ".woff", mime_type: "font/woff" },
    { extension: ".woff2", mime_type: "font/woff2" },
    { extension: ".xhtml", mime_type: "application/xhtml+xml" },
    ...
    { extension: ".xul", mime_type: "application/vnd.mozilla.xul+xml" },
    { extension: ".zip", mime_type: "application/zip" },
    { extension: ".3gp", mime_type: "video/3gpp" },
    { extension: ".3g2", mime_type: "video/3gpp2" },
    { extension: ".7z", mime_type: "application/x-7z-compressed" }
];