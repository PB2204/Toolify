...
const toolsList: Tool[] = [
  ...
  { name: 'DNS Lookup', slug: 'dns-whois-lookup', description: 'Look up DNS records.', icon: Network, category: 'Web & Development', isNew: true },
  ...
  { name: 'Emoji Picker', slug: 'emoji-picker', description: 'Find and copy emojis.', icon: Smile, category: 'Web & Development', isNew: true },

  // Calculators
  { name: 'Percentage Calculator', slug: 'percentage-calculator', description: 'Calculate percentages and discounts.', icon: Percent, category: 'Calculators' },
  { name: 'Loan Calculator', slug: 'loan-calculator', description: 'Calculate loan payments.', icon: Landmark, category: 'Calculators' },
