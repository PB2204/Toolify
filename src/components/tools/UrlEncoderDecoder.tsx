...
export default function UrlEncoderDecoder() {
  ...
  const handleEncode = () => {
    try {
      ...
      toast({ variant: 'destructive', title: 'Error', description: 'Could not encode the input URL.' });
      setOutput('');
    }
  };
  ...
  const handleDecode = () => {
    try {
      ...
      toast({ variant: 'destructive', title: 'Error', description: 'Could not decode the input URL. It may be malformed.' });
      setOutput('');
    }
  };
  ...
  return (
    <div className="max-w-4xl mx-auto">
      <Card>
        <CardHeader>
          <CardTitle className="font-headline text-2xl">URL Encoder / Decoder</CardTitle>
          <CardDescription>
        ...
        <CardContent className="space-y-4">
          <div className="grid gap-2">
            ...
            <Textarea
              ...
              placeholder="Paste URL or component to encode/decode..."
              rows={8}
              className="text-base"
            />
          </div>
