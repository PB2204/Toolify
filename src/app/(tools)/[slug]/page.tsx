...
export default function ToolPage({ params }: { params: { slug: string } }) {
  ...
  return (
    <div className="flex flex-col h-full">
      <header className="flex items-center gap-4 p-4 border-b bg-transparent sticky top-0 z-10 dark:border-white/10">
        <SidebarTrigger className="md:hidden text-foreground dark:text-white" />
